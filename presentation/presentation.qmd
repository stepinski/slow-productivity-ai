...
<!-- 2. My "Why": The Problem with Personal Productivity -->
...
::: {.notes}
The LlamaIndex integration provides the RAG (Retrieval-Augmented Generation) capabilities:
- It indexes all your Obsidian notes into vector embeddings
- The recursive SimpleDirectoryReader handles all your nested folders
...
talk to devops about K8s resources
```
...
- [ ] Discuss K8s with DevOps (Due: 4/15)
```
...
![](images/orange-pycon-lithuania-2025.png){width=20px}
